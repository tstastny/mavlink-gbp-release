...
typedef struct MAVLINK_PACKED __mavlink_nmpc_params_t
{
 ...
 float k_t_d; /*< Longitudinal logistic gain*/
 float e_d_co; /*< Longitudinal logistic cutoff [m]*/
 float k_t_ne; /*< Lateral logistic gain*/
 float e_ne_co; /*< Lateral logistic cutoff [m]*/
...
#define MAVLINK_MSG_ID_NMPC_PARAMS_LEN 104
#define MAVLINK_MSG_ID_NMPC_PARAMS_MIN_LEN 104
#define MAVLINK_MSG_ID_213_LEN 104
#define MAVLINK_MSG_ID_213_MIN_LEN 104

#define MAVLINK_MSG_ID_NMPC_PARAMS_CRC 189
#define MAVLINK_MSG_ID_213_CRC 189
...
#define MAVLINK_MESSAGE_INFO_NMPC_PARAMS { \
	...
	{  { "R_acpt", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_nmpc_params_t, R_acpt) }, \
         ...
         { "k_t_d", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_nmpc_params_t, k_t_d) }, \
         { "e_d_co", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_nmpc_params_t, e_d_co) }, \
         { "k_t_ne", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_nmpc_params_t, k_t_ne) }, \
         { "e_ne_co", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_nmpc_params_t, e_ne_co) }, \
         ...
         { "Qdiag", NULL, MAVLINK_TYPE_FLOAT, 16, 40, offsetof(mavlink_nmpc_params_t, Qdiag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NMPC_PARAMS { \
 ...
 * @param k_t_d Longitudinal logistic gain
 * @param e_d_co Longitudinal logistic cutoff [m]
 * @param k_t_ne Lateral logistic gain
 * @param e_ne_co Lateral logistic cutoff [m]
...
static inline uint16_t mavlink_msg_nmpc_params_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, const float *Qdiag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_NMPC_PARAMS_LEN];
	_mav_put_float(buf, 0, R_acpt);
	_mav_put_float(buf, 4, ceta_acpt);
	_mav_put_float(buf, 8, k_t_d);
	_mav_put_float(buf, 12, e_d_co);
	_mav_put_float(buf, 16, k_t_ne);
	_mav_put_float(buf, 20, e_ne_co);
	...
	_mav_put_float_array(buf, 40, Qdiag, 16);
...
{
	return mavlink_msg_nmpc_params_pack(system_id, component_id, msg, nmpc_params->R_acpt, nmpc_params->ceta_acpt, nmpc_params->k_t_d, nmpc_params->e_d_co, nmpc_params->k_t_ne, nmpc_params->e_ne_co, nmpc_params->eps_v, nmpc_params->alpha_p_co, nmpc_params->alpha_m_co, nmpc_params->alpha_delta_co, nmpc_params->Qdiag);
}
...
{
	return mavlink_msg_nmpc_params_pack_chan(system_id, component_id, chan, msg, nmpc_params->R_acpt, nmpc_params->ceta_acpt, nmpc_params->k_t_d, nmpc_params->e_d_co, nmpc_params->k_t_ne, nmpc_params->e_ne_co, nmpc_params->eps_v, nmpc_params->alpha_p_co, nmpc_params->alpha_m_co, nmpc_params->alpha_delta_co, nmpc_params->Qdiag);
}
...
static inline void mavlink_msg_nmpc_params_send(mavlink_channel_t chan, float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, const float *Qdiag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_NMPC_PARAMS_LEN];
	_mav_put_float(buf, 0, R_acpt);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_nmpc_params_send(chan, nmpc_params->R_acpt, nmpc_params->ceta_acpt, nmpc_params->k_t_d, nmpc_params->e_d_co, nmpc_params->k_t_ne, nmpc_params->e_ne_co, nmpc_params->eps_v, nmpc_params->alpha_p_co, nmpc_params->alpha_m_co, nmpc_params->alpha_delta_co, nmpc_params->Qdiag);
#else
 ...
 */
static inline void mavlink_msg_nmpc_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, const float *Qdiag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
	return _MAV_RETURN_float_array(msg, Qdiag, 16,  40);
}

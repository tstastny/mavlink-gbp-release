 ...
 * @param i_e_t_co Track error integral cutoff [m]
...
static inline uint16_t mavlink_msg_nmpc_params_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, float i_e_t_co, const float *Qdiag)
{
...
{
	return mavlink_msg_nmpc_params_pack(system_id, component_id, msg, nmpc_params->R_acpt, nmpc_params->ceta_acpt, nmpc_params->k_t_d, nmpc_params->e_d_co, nmpc_params->k_t_ne, nmpc_params->e_ne_co, nmpc_params->eps_v, nmpc_params->alpha_p_co, nmpc_params->alpha_m_co, nmpc_params->alpha_delta_co, nmpc_params->i_e_t_co, nmpc_params->Qdiag);
}
...
static inline void mavlink_msg_nmpc_params_send(mavlink_channel_t chan, float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, float i_e_t_co, const float *Qdiag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_NMPC_PARAMS_LEN];
	_mav_put_float(buf, 0, R_acpt);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_nmpc_params_send(chan, nmpc_params->R_acpt, nmpc_params->ceta_acpt, nmpc_params->k_t_d, nmpc_params->e_d_co, nmpc_params->k_t_ne, nmpc_params->e_ne_co, nmpc_params->eps_v, nmpc_params->alpha_p_co, nmpc_params->alpha_m_co, nmpc_params->alpha_delta_co, nmpc_params->i_e_t_co, nmpc_params->Qdiag);
#else
 ...
 */
static inline void mavlink_msg_nmpc_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float R_acpt, float ceta_acpt, float k_t_d, float e_d_co, float k_t_ne, float e_ne_co, float eps_v, float alpha_p_co, float alpha_m_co, float alpha_delta_co, float i_e_t_co, const float *Qdiag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field i_e_t_co from nmpc_params message
 *
 * @return Track error integral cutoff [m]
 */
static inline float mavlink_msg_nmpc_params_get_i_e_t_co(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_nmpc_params_decode(const mavlink_message_t* msg, mavlink_nmpc_params_t* nmpc_params)
{
	...
	nmpc_params->i_e_t_co = mavlink_msg_nmpc_params_get_i_e_t_co(msg);
